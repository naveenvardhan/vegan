class Item < ApplicationRecord
  ...
  VEG_IMAGES = {
    ...
    "Ginger" => "ginger.jpg",
    "Garlic big A" => "garlic.webp",
    "Garlic medium A" => "garlic-b.jpg",
    "Garlic pudi" => "garlic-pudi.webp",
    ...
    "Brinjal purple round B" => "brinjal-purple.jpeg",
    "Brinjal Bottle Black" => "brinjalbottleblack.jpg",
    "Brinjal Long Green" => "longbrinjal.jpg",
    "Brinjal (Long Green)" => "longbrinjal.jpg",
    "Brinjal long B" => "longbrinjal.jpg",
    "Boodu Kumbalakayi" => "ash-guard.jpg",
    "Ash Gourd" => "ash-guard.jpg",
    "Kumbalakayi (Pumpkin)" => "pumpkin.webp",
    ...
    "Tomato Nati A(12kg)" => "tomato-20-a.jpg",
    "Tomato nati B(22kgs)" => "nati-tomato-b.jpeg",
    "Tomato nati B(12kgs)" => "nati-tomato-b.jpeg",
    "Tomato Hybrid / Seeds A(22kg)" => "tomato-seeds-22.webp",
    "Tomato Hybrid / Seeds A(12kg)" => "tomato-seeds-12.webp",
    "Tomato Hybrid / Seeds B(12kgs)" => "tomato-seeds-12.webp",
    "Capsicum A(25kg)" => "capsicum-a-bag.jpg",
    "Capsicum A(20kg)" => "capsicum-a-bag.jpg",
    "Capsicum B(20kg)" => "capsicum-b-bag.jpg",
    ...
    "Garlic Big A (30kg)" => "garlic-30.webp",
    "Garlic Medium A (30kg)" => "garlic-30.webp",
    "Beetroot A(20kg)" => "beetroot-bag.jpg",
    "Beans nati A(60kgs)" => "beans_nati.webp",
    "Beans nati B(20kg)" => "beans_nati.webp",
    "Beans haricot A(60kg)" => "beans-haricot.jpg",
    "Beans haricot B(20kg)" => "haricot-beans-b.jpg",
    "Carrot nati A(60kg)" => "carrot-nati-bag.jpg",
    "Carrot nati A(20kg)" => "carrot-nati-bag.jpg",
    "Carrot nati B(20kgs)" => "carrot-nati-bag.jpg",
    "Chow chow A(20kg)" => "chow-chow-a.jpg",
    "Green chilli A (60kg)" => "chilli-a-bag.webp",
    "Green chilli B(20kgs)" => "chilli-b-bag.webp",
    "Cauliflower A (15pc)" => "cauliflower-bag.jpeg",
    "Beetroot A(50kg)" => "beetroot-bag.jpg",
    "Green chilli long(60kg)" => "green-chilli-long-bag.jpg",
    "Cucumber A(45kg)" => "cucumber-bag.webp",
    "Cucumber A(20kg)" => "cucumber-A.jpg",
    "Ginger A(60kg)" => "ginger.jpg",
    "Bajji chilli A(20kg)" => "bajji-chilli-a.jpg",
    "Bajji chilli B(20kgs)" => "bajji-chilli-a.jpg",
    "Carrot ooty A(85kg)" => "carrot-ooty-bag.webp",
    "Knol Khol A(50kg)" => "kohlrabi.jpeg",
    "Green peas A(60kgs)" => "peas.jpeg",
    "Cabbage local (45kg)" => "cabbage-bag.jpg",
    ...
    "Pumpkin small (30kg)" => "pumpkin.webp"
  }.freeze
